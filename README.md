...
- **Prévia de criativos sem link.** Alguns anúncios chegam da extração sem URL de prévia (no TikTok, os MEDX DIGENAL e PROFESSOR vêm sem `Video Thumbnail URL` em todas as linhas). `lib/creativeOverrides.ts` guarda um link de reserva por nome de anúncio; a URL da extração, quando existe, continua tendo prioridade, e o link de reserva também cobre a thumbnail assinada do TikTok quando ela expira. Para um criativo novo, basta acrescentar o nome e o link.
