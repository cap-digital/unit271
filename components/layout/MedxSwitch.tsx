...
/** Switch MEDX: ligado mostra somente a campanha MEDX; desligado, somente a campanha 27.1. */
export function MedxSwitch({ layout = "vertical" }: MedxSwitchProps) {
  ...
  return (
    <button
      ...
      role="switch"
      aria-checked={medx}
      aria-label={medx ? "Modo MEDX ativo. Desativar para ver a campanha 27.1" : "Ativar modo MEDX"}
      ...
      title="Alterna entre a campanha MEDX e a campanha 27.1"
    >
